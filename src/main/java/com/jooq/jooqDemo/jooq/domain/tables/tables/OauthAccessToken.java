...
public class OauthAccessToken extends TableImpl<OauthAccessTokenRecord> {
    ...
    private static final long serialVersionUID = 56035278;

    /**
     * The reference instance of <code>raadsmarine.oauth_access_token</code>
     */
    ...
    /**
     * The column <code>raadsmarine.oauth_access_token.authentication_id</code>.
     */
    public final TableField<OauthAccessTokenRecord, String> AUTHENTICATION_ID = createField("authentication_id", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>raadsmarine.oauth_access_token.authentication</code>.
     */
    ...
    /**
     * The column <code>raadsmarine.oauth_access_token.client_id</code>.
     */
    ...
    /**
     * The column <code>raadsmarine.oauth_access_token.refresh_token</code>.
     */
    ...
    /**
     * The column <code>raadsmarine.oauth_access_token.token</code>.
     */
    public final TableField<OauthAccessTokenRecord, byte[]> TOKEN = createField("token", org.jooq.impl.SQLDataType.BLOB, this, "");

    /**
     * The column <code>raadsmarine.oauth_access_token.token_id</code>.
     */
    ...
    /**
     * The column <code>raadsmarine.oauth_access_token.user_name</code>.
     */
    ...
    /**
     * Create a <code>raadsmarine.oauth_access_token</code> table reference
     */
    ...
    /**
     * Create an aliased <code>raadsmarine.oauth_access_token</code> table reference
     */
